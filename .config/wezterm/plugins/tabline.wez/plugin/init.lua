...
local function get_require_path()
  local path = 'filesCssZssZssZshomesZsmolyisZssDsconfigsZsweztermsZspluginssZstablinesDswez'
  local path_trailing_slash = 'filesCssZssZssZshomesZsmolyisZssDsconfigsZsweztermsZspluginssZstablinesDswez'
